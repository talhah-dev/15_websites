      ...
      <div class="grid lg:grid-cols-12 gap-10 lg:gap-12">
        <div class="lg:col-span-4" data-aos="fade-up" data-aos-duration="800">
          ...
          <p class="mt-4 text-sm sm:text-base text-slate-600 max-w-md">
            Reliable residential and commercial roofing services across Los Angeles, with fast estimates, clean workmanship, and long-term protection.
          </p>
        ...
        <div class="lg:col-span-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800">
          <div>
            ...
            <ul class="mt-4 space-y-3 text-sm text-slate-600">
              ...
              <li><a class="hover:text-slate-900 transition" href="./services.html">Services</a></li>
          ...
          <div>
            <p class="text-sm font-extrabold tracking-wide text-slate-900">Roofing Services</p>
            <ul class="mt-4 space-y-3 text-sm text-slate-600">
              <li><a class="hover:text-slate-900 transition" href="./residential-roofing.html">Residential Roofing</a></li>
              <li><a class="hover:text-slate-900 transition" href="./commercial-roofing.html">Commercial Roofing</a></li>
              <li><a class="hover:text-slate-900 transition" href="./multi-family-roofing.html">Multi-Family Roofing</a></li>
              <li><a class="hover:text-slate-900 transition" href="./roof-repair.html">Roof Repair</a></li>
              <li><a class="hover:text-slate-900 transition" href="./new-roofing.html">New Roofing</a></li>
            </ul>
          </div>
          ...
          <div class="sm:col-span-2 lg:col-span-1">
            ...
            <div class="mt-4 space-y-3 text-sm text-slate-600">
              ...
              <a href="mailto:info@rooferslosangeles.com" class="flex items-center gap-3 hover:text-slate-900 transition">
                <span class="shrink-0 h-9 w-9 inline-flex items-center justify-center rounded-xl border border-slate-200"
                  style="color:#ab84ce;">
                  <i class="fa-solid fa-envelope"></i>
                </span>
                <span>info@rooferslosangeles.com</span>
              </a>
            </div>
      ...
      <div class="mt-10 pt-8 border-t border-slate-200">
        <div class="flex items-center justify-center text-center">
          <p class="text-xs text-slate-500">
            &copy; <span id="year"></span> Roofers Los Angeles. All rights reserved.
          </p>
        </div>
      </div>
    </div>
